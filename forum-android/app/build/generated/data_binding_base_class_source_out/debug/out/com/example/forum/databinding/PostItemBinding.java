...
public final class PostItemBinding implements ViewBinding {
  ...
  private PostItemBinding(@NonNull LinearLayout rootView, @NonNull TextView tvSubTitle,
      @NonNull TextView tvTitle, @NonNull TextView tvUpdateDate) {
  ...
  public static PostItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PostItemBinding((LinearLayout) rootView, tvSubTitle, tvTitle, tvUpdateDate);
    }
